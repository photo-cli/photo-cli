	...
	{
		{
			...
			new List<PhotoCsv>
			{
				...
				SingleSpain1(null, false, "Community of Madrid", "Comunidad de Madrid", "Madrid Metropolitan Area"),
				SingleSpain2(null, false, "Community of Madrid", "Comunidad de Madrid", "Madrid Metropolitan Area"),
				SingleNoGpsCoordinateAndNoPhotoTakenDate(useFullPath: false),
				SingleNoPhotoTakenDate(useFullPath: false),
			},
			new ConsoleOutputValues(18, HasTakenDateAndCoordinate: 15, HasNoTakenDateAndCoordinate: 2, HasTakenDateButNoCoordinate: 1)
	...
	{
		{
			...
			new List<PhotoCsv>
			{
				...
				SubFoldersSpain1(null, false, "Community of Madrid", "Comunidad de Madrid", "Madrid Metropolitan Area"),
				SubFoldersSpain2(null, false, "Community of Madrid", "Comunidad de Madrid", "Madrid Metropolitan Area"),
				SubFoldersNoGpsCoordinateAndNoPhotoTakenDate(useFullPath: false),
				SubFoldersNoPhotoTakenDate(useFullPath: false),
			},
			new ConsoleOutputValues(18, HasTakenDateAndCoordinate: 15, HasNoTakenDateAndCoordinate: 2, HasTakenDateButNoCoordinate: 1)
