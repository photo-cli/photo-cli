...
public class CopyOptions : IReverseGeocodeOptions
{
	...
	public CopyOptions(
		...
		IEnumerable<string>? googleMapsAddressTypes = null, string? googleMapsApiKey = null, IEnumerable<string>? openStreetMapProperties = null, string? mapQuestApiKey = null,
